...
## 1
ok { fp-ebnf-parse($ebnfCode1, <EVAL>, target => 'Raku::Class', name => Whatever) };

## 2
my $pObj2 = fp-ebnf-parse($ebnfCode1, <EVAL>, target => 'Raku::Class');
...
my $pObj5 = fp-ebnf-parse($ebnfCode5, <EVAL>, target => 'Raku::Class', name => 'MyFP3');
my $p5 = $pObj5.new;
